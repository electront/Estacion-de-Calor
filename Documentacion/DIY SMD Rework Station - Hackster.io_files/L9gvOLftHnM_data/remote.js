...
K:"ytp-mdx-popup-dialog",J:{role:"dialog"},V:[{D:"div",K:"ytp-mdx-popup-dialog-inner-content",V:[{D:"div",K:"ytp-mdx-popup-title",YN:"No has iniciado sesi\u00f3n"},{D:"div",K:"ytp-mdx-popup-description",YN:"Los v\u00eddeos que veas podr\u00edan aparecer en el historial de reproducciones de la TV e influir en las recomendaciones. Puedes evitarlo si cancelas e inicias sesi\u00f3n en YouTube desde tu ordenador."},{D:"div",K:"ytp-mdx-privacy-popup-buttons",V:[{D:"button",LM:["ytp-button","ytp-mdx-privacy-popup-cancel"],
YN:"Cancelar"},{D:"button",LM:["ytp-button","ytp-mdx-privacy-popup-confirm"],YN:"Confirmar"}]}]}]});this.fade=new g.SL(this,250);this.cancelButton=this.vk("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.vk("ytp-mdx-privacy-popup-confirm");g.X(this,this.fade);this.U(this.cancelButton,"click",this.X);this.U(this.confirmButton,"click",this.W)},GB=function(h){g.p.call(this,{D:"div",
K:"ytp-remote",V:[{D:"div",K:"ytp-remote-display-status",V:[{D:"div",K:"ytp-remote-display-status-icon",V:[g.rPl()]},{D:"div",K:"ytp-remote-display-status-text",YN:"{{statustext}}"}]}]});this.api=h;this.fade=new g.SL(this,250);g.X(this,this.fade);this.U(h,"presentingplayerstatechange",this.onStateChange);this.So(h.getPlayerStateObject())},Z5=function(h,W){g.Xt.call(this,"Reproducir en",1,h,W);
...
break;case -1:this.Tz(new g.l1(64));break;case -1E3:this.Tz(new g.l1(128,{errorCode:"mdx.remoteerror",errorMessage:"Este v\u00eddeo no se puede reproducir de forma remota.",mz:2}))}h=Xb(this.tI).trackData;var W=this.Y;(h||W?h&&W&&h.trackName==W.trackName&&h.languageCode==W.languageCode&&h.languageName==W.languageName&&h.kind==W.kind:1)||(this.Y=h,ENK(this,h));h=Xb(this.tI);h.volume===-1||Math.round(this.L.getVolume())===h.volume&&this.L.isMuted()===h.muted||this.T.isActive()||this.EB()}else HxX(this)};
...
GB.prototype.So=function(h){if(this.api.getPresentingPlayerType()===3){var W={RECEIVER_NAME:this.api.getOption("remote","currentReceiver").name};h=g.Y(h,128)?g.hl("No se ha podido reproducir el v\u00eddeo en $RECEIVER_NAME",W):h.isPlaying()||h.isPaused()?g.hl("El v\u00eddeo se est\u00e1 reproduciendo en $RECEIVER_NAME",W):g.hl("Conectado a $RECEIVER_NAME",W);this.updateValue("statustext",h);this.fade.show()}else this.fade.hide()};g.n(Z5,g.Xt);Z5.prototype.Y=function(){var h=this.L.getOption("remote","receivers");h&&h.length>1&&!this.L.getOption("remote","quickCast")?(this.a5=g.D2(h,this.X,this),this.Yy(g.xw(h,this.X)),h=this.L.getOption("remote","currentReceiver"),h=this.X(h),this.options[h]&&this.BB(h),this.enable(!0)):this.enable(!1)};
Z5.prototype.X=function(h){return h.key};
Z5.prototype.GS=function(h){return h==="cast-selector-receiver"?"Enviar...":this.a5[h].name};
